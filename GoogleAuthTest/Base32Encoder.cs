...
{
    /// <summary>
    /// Encodes text into Base32. Based on: http://bit.ly/1NpOoyI
    /// </summary>
    public class Base32Encoder
    {
        ...
        private int DecodeLastBlock(ICollection<byte> outStream, char c1, char c2, char c3, char c4, char c5, char c6, char c7, char c8)
        {
            if (c3 == padding)
            {
                byte b1 = dTable[c1];
